""" dataCommons.reporting.reports.summaryRequestTimes

    This module implements the "Summary Request Times" report for the 3taps
    Reporting system.
"""
...
type = "summaryRequestTimes"

#############################################################################

# A user-visible name for this report:

name = "Summary Request Times"

#############################################################################

# A user-visible description for this report:

description = "This report shows how long it took to process each summary " \
            + "request."
...
params = [{'name'     : "timeframe",
           'label'    : "View summary request times for the last",
           'required' : True,
           'type'     : "timeframe",
           'default'  : "1h"},
]
...
renderer = """
    function render(data) {
        ...
        $.plot($("#report"), [
            ...
            yaxis: {axisLabel: "Summary Request Processing Time (ms)"}});
    }
"""
