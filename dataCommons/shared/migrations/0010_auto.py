...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Posting.location_bounds'
        db.add_column('shared_posting', 'location_bounds',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Posting.location_bounds'
        db.delete_column('shared_posting', 'location_bounds')
