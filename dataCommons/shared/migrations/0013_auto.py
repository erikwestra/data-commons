...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('shared_settings')

        # Adding field 'Posting.updated'
        db.add_column('shared_posting', 'updated',
    ...
    def backwards(self, orm):
        ...
        db.create_table('shared_settings', (
        ...
        db.send_create_signal('shared', ['Settings'])

        # Deleting field 'Posting.updated'
        db.delete_column('shared_posting', 'updated')
