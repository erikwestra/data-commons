...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Posting.status_wanted'
        db.add_column('shared_posting', 'status_wanted',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Posting.status_wanted'
        db.delete_column('shared_posting', 'status_wanted')
