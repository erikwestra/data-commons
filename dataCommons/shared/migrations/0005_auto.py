...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Posting', fields ['immortal']
        db.create_index('shared_posting', ['immortal'])

        # Adding index on 'Posting', fields ['status_lost']
        db.create_index('shared_posting', ['status_lost'])

        # Adding index on 'Posting', fields ['status_offered']
        db.create_index('shared_posting', ['status_offered'])

        # Adding index on 'Posting', fields ['status_stolen']
        db.create_index('shared_posting', ['status_stolen'])

        # Adding index on 'Posting', fields ['status_found']
        db.create_index('shared_posting', ['status_found'])


    def backwards(self, orm):
        # Removing index on 'Posting', fields ['status_found']
        db.delete_index('shared_posting', ['status_found'])

        # Removing index on 'Posting', fields ['status_stolen']
        db.delete_index('shared_posting', ['status_stolen'])

        # Removing index on 'Posting', fields ['status_offered']
        db.delete_index('shared_posting', ['status_offered'])

        # Removing index on 'Posting', fields ['status_lost']
        db.delete_index('shared_posting', ['status_lost'])

        # Removing index on 'Posting', fields ['immortal']
        db.delete_index('shared_posting', ['immortal'])
