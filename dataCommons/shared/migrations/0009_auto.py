...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.bounds_min_latitude'
        db.add_column('shared_location', 'bounds_min_latitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=5),
                      keep_default=False)

        # Adding field 'Location.bounds_min_longitude'
        db.add_column('shared_location', 'bounds_min_longitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=5),
                      keep_default=False)

        # Adding field 'Location.bounds_max_latitude'
        db.add_column('shared_location', 'bounds_max_latitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=5),
                      keep_default=False)

        # Adding field 'Location.bounds_max_longitude'
        db.add_column('shared_location', 'bounds_max_longitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.bounds_min_latitude'
        db.delete_column('shared_location', 'bounds_min_latitude')

        # Deleting field 'Location.bounds_min_longitude'
        db.delete_column('shared_location', 'bounds_min_longitude')

        # Deleting field 'Location.bounds_max_latitude'
        db.delete_column('shared_location', 'bounds_max_latitude')

        # Deleting field 'Location.bounds_max_longitude'
        db.delete_column('shared_location', 'bounds_max_longitude')
