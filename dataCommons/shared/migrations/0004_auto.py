...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Posting.inserted'
        db.add_column('shared_posting', 'inserted',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Posting.inserted'
        db.delete_column('shared_posting', 'inserted')
    ...
    models = {
        ...
        'shared.posting': {
            ...
            'inserted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow', 'db_index': 'True'}),
