...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Posting', fields ['currency']
        db.create_index('shared_posting', ['currency'])


    def backwards(self, orm):
        # Removing index on 'Posting', fields ['currency']
        db.delete_index('shared_posting', ['currency'])
